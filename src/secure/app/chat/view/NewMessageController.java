...
public class NewMessageController {
    ...
    @FXML
    private void handleSend() throws RemoteException {
    	...
    	if(toField.getText().equals("") || subjectField.getText().equals("") || 
            ...
            alert.showAndWait();
        } else if(!i.getUsers().contains(toField.getText())) {
        	
        	Alert alert = new Alert(AlertType.WARNING);
            alert.initOwner(mainApp.getPrimaryStage());
            alert.setTitle("Invalid user");
            alert.setHeaderText("No such registered user in the system");
            alert.setContentText("Please enter valid recipient when sending!");
